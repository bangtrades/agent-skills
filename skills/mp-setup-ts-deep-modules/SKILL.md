...
<!-- VENDORED from https://github.com/mattpocock/skills @ v1.2.3 (2026-08-06). Generated by bin/sync-upstream.sh — do not edit; changes are overwritten on the next sync. Upstream name: setup-ts-deep-modules -->
...
For the vocabulary (deep module, interface, seam, depth), run the `/mp-codebase-design` skill — use its language throughout.
